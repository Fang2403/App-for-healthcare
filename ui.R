                   ...
                   sidebarLayout(
                       sidebarPanel(
                           ...
                           conditionalPanel(condition="input.filter1=='Yes'",
                                            selectInput("num_var_rows", "filter rows", 
                                                        choices = c("","gender=='Male'", "gender=='Female'",
                   ...
                   sidebarLayout(
                       sidebarPanel(
                           ...
                           conditionalPanel(condition="input.filter2=='Yes'",
                                            selectInput("one_way_rows", "filter rows", 
                                                        choices = c("","gender=='Male'", "gender=='Female'",
                                                                    "hypertension==0", "hypertension==1",
                                                                    "heart_disease==0", "heart_disease==1",
                                                                    "ever_married=='Yes'","ever_married=='No'" ,
                           ...
                           conditionalPanel(condition="input.filter3=='Yes'",
                                            selectInput("two_way_rows", "filter rows", 
                                                        choices = c("","gender=='Male'", "gender=='Female'",
                                                                    "hypertension==0", "hypertension==1",
                                                                    "heart_disease==0", "heart_disease==1",
                                                                    "ever_married=='Yes'","ever_married=='No'" ,
                             ...
                             sidebarPanel(
                                 ...
                                 conditionalPanel(condition="input.plotoption=='Histogram'",
                                                  ...
                                                  conditionalPanel(condition="input.fil1=='Yes'",
                                                                   selectInput("plotNumVar3", 
                                                                               "Choose filter Varibale",
                                                                               choices = c("","gender=='Male'",
                                                                                           "gender=='Female'",
                                                                                           "hypertension==0",
                                                                                           "hypertension==1",
                                                                                           "heart_disease==0",
                 ...
                 sidebarPanel(
                     ...
                     conditionalPanel(condition="input.showdata=='Subset Data'",
                                      selectInput("data_cols", "select columns ", 
                                                      ...
                                                      multiple = TRUE),
                                      selectInput("data_rows", "filter rows", 
                                                  choices = c("","gender=='Male'", "gender=='Female'", 
                                                              "hypertension==0", "hypertension==1",
                                                              "heart_disease==0", "heart_disease==1",
                                                              "ever_married=='Yes'","ever_married=='No'" ,
